...
with tabs[0]:
    if filtered.empty:
        ...
        with ch1:
            ...
            st.plotly_chart(fig_t,use_container_width=True,key="chart_1")
        ...
        with ch2:
            ...
            st.plotly_chart(fig_cb,use_container_width=True,key="chart_2")
        ...
        st.plotly_chart(fig_yoy,use_container_width=True,key="chart_3")
...
with tabs[1]:
    ...
    if not filtered.empty:
        ...
        st.plotly_chart(fig_tr,use_container_width=True,key="chart_4")
        ...
        st.plotly_chart(fig_a,use_container_width=True,key="chart_5")
        ...
        st.plotly_chart(fig_sv,use_container_width=True,key="chart_6")
        ...
        if not type_df.empty:
            ...
            st.plotly_chart(fig_tt,use_container_width=True,key="chart_7")
...
with tabs[2]:
    ...
    if not filtered.empty:
        ...
        with col_a:
            ...
            st.plotly_chart(fig_s,use_container_width=True,key="chart_8")
        ...
        with col_b:
            ...
            st.plotly_chart(fig_cr,use_container_width=True,key="chart_9")
        ...
        with d1:
            ...
            fig_it.update_layout(yaxis=dict(categoryorder="total ascending")); st.plotly_chart(fig_it,use_container_width=True,key="chart_10")
        with d2:
            ...
            fig_dt.update_layout(yaxis=dict(categoryorder="total ascending")); st.plotly_chart(fig_dt,use_container_width=True,key="chart_11")
...
with tabs[3]:
    ...
    if not filtered.empty:
        ...
        st.plotly_chart(fig_imp,use_container_width=True,key="chart_12")
        ...
        st.plotly_chart(fig_sv_box,use_container_width=True,key="chart_13")
        ...
        if period_a and period_b:
            ...
            st.plotly_chart(fig_c,use_container_width=True,key="chart_14")
...
with tabs[4]:
    ...
    if not filtered.empty:
        ...
        st.plotly_chart(fig_hm,use_container_width=True,key="chart_15")
        ...
        if len(dual)>0:
            ...
            fig_dh.update_layout(yaxis=dict(categoryorder="total ascending")); st.plotly_chart(fig_dh,use_container_width=True,key="chart_16")
        ...
        fig_is.update_layout(legend_title="Breach Category"); st.plotly_chart(fig_is,use_container_width=True,key="chart_17")
        ...
        fig_ds.update_layout(coloraxis_showscale=False,yaxis=dict(categoryorder="total ascending")); st.plotly_chart(fig_ds,use_container_width=True,key="chart_18")
        ...
        fig_tm.update_layout(margin=dict(t=30,b=10)); st.plotly_chart(fig_tm,use_container_width=True,key="chart_19")
...
with tabs[5]:
    ...
    if not filtered.empty:
        ...
        st.plotly_chart(fig_yr,use_container_width=True,key="chart_20")
        ...
        st.plotly_chart(fig_pv,use_container_width=True,key="chart_21")
...
with tabs[6]:
    ...
    # model_results and best_name already computed at module level
    ...
    with rc1:
        ...
        st.plotly_chart(fig_roc,use_container_width=True,key="chart_22")
    ...
    with rc2:
        ...
        st.plotly_chart(fig_cm,use_container_width=True,key="chart_23")
    ...
    if m_ch=="Random Forest" and res.get("fi") is not None:
        ...
        fig_fi.update_layout(yaxis=dict(categoryorder="total ascending"),coloraxis_showscale=False); st.plotly_chart(fig_fi,use_container_width=True,key="chart_24")
...
with tabs[7]:
    ...
    if st.button("Estimate cyber breach probability",use_container_width=True):
        ...
        with g_col:
            ...
            fig_g.update_layout(height=300,margin=dict(t=60,b=20)); st.plotly_chart(fig_g,use_container_width=True,key="chart_25")
        with t_col:
